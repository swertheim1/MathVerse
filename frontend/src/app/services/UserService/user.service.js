...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        function UserService_1(tokenService) {
            this.tokenService = tokenService;
        }
        UserService_1.prototype.getGradeLevelFromLocalStorage = function () {
        ...
        UserService_1.prototype.getUserIdFromLocalStorage = function () {
            var token = localStorage.getItem('authToken');
            if (token) {
                var decodedToken = this.tokenService.decodeToken(token);
        ...
        UserService_1.prototype.getTopicsFromLocalStorage = function () {
            var topics = localStorage.getItem('topics_list');
            if (topics) {
                // Parse the JSON string to convert it back to an array of objects
                var topicsList = JSON.parse(topics);
        ...
        UserService_1.prototype.getNumbersetsFromLocalStorage = function () {
            var numbersets = localStorage.getItem('numbersets_list');
            if (numbersets) {
                // Parse the JSON string to convert it back to an array of objects
                var numbersetsList = JSON.parse(numbersets);
